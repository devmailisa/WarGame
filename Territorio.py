...
class Territorio:
    '''
    É uma classe que implementa cada território do mapa do War, armazenando informações como:
      o nome self.__nome; 
      o continente a que pertence self.__continente; 
      a quantidade de exércitos presentes self.__qtd_exercitos; 
      o jogador que o contém self.__dono; 
      os territórios que lhe fazem fronteira self.__fronteiras; 
      e uma identificação self.__id, a partir da qual é possível resgatar o objeto Território de forma mais sucinta. 
    
    Os métodos implementados são para o retorno e manipulação dessas propriedades.
    '''
